...
async fn time_travel_by_ds() {
    ...
    // Use action timestamp from version for binary search instead of using mtime reported by filesystem.

    let mut table =
        deltalake::open_table_with_ds("./tests/data/simple_table", "2020-04-27T06:23:04-00:00")
            .await
            .unwrap();
    assert_eq!(table.version, 0);

    table = deltalake::open_table_with_ds("./tests/data/simple_table", "2020-04-27T06:23:18-00:00")
        .await
        .unwrap();
    assert_eq!(table.version, 1);

    table = deltalake::open_table_with_ds("./tests/data/simple_table", "2020-04-27T06:23:20-00:00")
        .await
        .unwrap();
    assert_eq!(table.version, 1);


    table = deltalake::open_table_with_ds("./tests/data/simple_table", "2020-04-27T06:23:25-00:00")
        .await
        .unwrap();
    assert_eq!(table.version, 2);


    table = deltalake::open_table_with_ds("./tests/data/simple_table", "2020-04-27T06:23:35-00:00")
        .await
        .unwrap();
    assert_eq!(table.version, 3);

    table = deltalake::open_table_with_ds("./tests/data/simple_table", "2020-04-27T06:23:37-00:00")
        .await
        .unwrap();
    assert_eq!(table.version, 3);


    table = deltalake::open_table_with_ds("./tests/data/simple_table", "2020-04-27T06:23:47-00:00")
        .await
        .unwrap();
    assert_eq!(table.version, 4);

    table = deltalake::open_table_with_ds("./tests/data/simple_table", "2020-04-27T06:23:49-00:00")
        .await
        .unwrap();
    assert_eq!(table.version, 4);
